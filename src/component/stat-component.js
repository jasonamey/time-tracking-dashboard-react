...
//JASON HERE : use this to access the context
...
function StatComponent(props) {
  //JASON HERE : accessing value timeframe from the userContext...
  const {timeFrame} = useUserContext();
    ...
    <>
      <Card>
        ...
        <Container>
          ...
          <StatWrapper>
            <CurrentStat>
              {localData[activityIndex].timeframes[`${timeFrame}`]["current"]}
              hrs
            </CurrentStat>
            <PreviousStat>
              Previuos -{" "}
              {localData[activityIndex].timeframes[`${timeFrame}`]["previous"]}{" "}
              hrs
            </PreviousStat>
          </StatWrapper>
        </Container>
